...
public class P140_WordBreakII {
    ...
    public static void main(String[] args) {
        P140_WordBreakII p_140WordBreakII = new P140_WordBreakII();
        System.out.println(p_140WordBreakII.wordBreak3("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Arrays.asList(new String[]{"a","aa","aaa","aaaa","aaaaa","aaaaaa","aaaaaaa","aaaaaaaa","aaaaaaaaa","aaaaaaaaaa"})));
        System.out.println(p_140WordBreakII.count);
    }
